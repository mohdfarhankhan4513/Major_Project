package trainedge.multilingualmessenger.ui.fragments;
...
import trainedge.multilingualmessenger.R;
import trainedge.multilingualmessenger.core.registration.RegisterContract;
import trainedge.multilingualmessenger.core.registration.RegisterPresenter;
import trainedge.multilingualmessenger.core.users.add.AddUserContract;
import trainedge.multilingualmessenger.core.users.add.AddUserPresenter;
import trainedge.multilingualmessenger.ui.activities.UserListingActivity;
...
public class RegisterFragment extends Fragment implements View.OnClickListener, RegisterContract.View, AddUserContract.View {
    ...
    private void init() {
        mRegisterPresenter = new RegisterPresenter((RegisterContract.View) this);
        mAddUserPresenter = new AddUserPresenter((AddUserContract.View) this);
