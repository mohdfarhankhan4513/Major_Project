...
import static trainedge.multilingualmessenger.R.id.text;
...
public class GoogleTranslate {
    ...
    public static void main(String[] args) {
        ...
        GoogleTranslate translator = new GoogleTranslate("AIzaSyC9cH5-M8Ce-3zQfIciY-7VjGUb2WoB7Ho");//change it to your own apikey generated by google
